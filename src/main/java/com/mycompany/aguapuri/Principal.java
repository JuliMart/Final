 ...
 */
package com.mycompany.aguapuri;

import Views.vwCliente;
import Views.vwProducto;
import Views.vwVendedor;
import Views.vwVenta;
import DTO.Persona;
import DTO.Cliente;
import DTO.Vendedor;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnVendedor = new javax.swing.JMenuItem();
        ...
        jMenu2.add(mnProducto);

        mnVendedor.setText("Vendedor");
        mnVendedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnVendedorActionPerformed(evt);
            }
        });
        jMenu2.add(mnVendedor);
    ...
    private void mnVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnVendedorActionPerformed
        vwVendedor vende = new vwVendedor();
        escritorio.add(vende);
        vende.setVisible(true);

    

        
    }//GEN-LAST:event_mnVendedorActionPerformed

    private void mnProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnProductoActionPerformed
        vwProducto pro = new vwProducto();
        escritorio.add(pro);
        pro.setVisible(true);
    ...
    private javax.swing.JMenuItem mnVendedor;
